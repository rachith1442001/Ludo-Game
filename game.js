...
var redpath = [
  19, 20, 21, 22, 23, 15, 12, 9, 6, 3, 0, 1, 2, 5, 8, 11, 14, 17, 24, 25, 26,
  27, 28, 29, 41, 53, 52, 51, 50, 49, 48, 56, 59, 62, 65, 68, 71, 70, 69, 66,
  63, 60, 57, 54, 47, 46, 45, 44, 43, 42, 30, 31, 32, 33, 34, 35,
];
var greenpath = [
  5, 8, 11, 14, 17, 24, 25, 26, 27, 28, 29, 41, 53, 52, 51, 50, 49, 48, 56, 59,
  62, 65, 68, 71, 70, 69, 66, 63, 60, 57, 54, 47, 46, 45, 44, 43, 42, 30, 18,
  19, 20, 21, 22, 23, 15, 12, 9, 6, 3, 0, 1, 4, 7, 10, 13, 16,
];
var bluepath = [
  66, 63, 60, 57, 54, 47, 46, 45, 44, 43, 42, 30, 18, 19, 20, 21, 22, 23, 15,
  12, 9, 6, 3, 0, 1, 2, 5, 8, 11, 14, 17, 24, 25, 26, 27, 28, 29, 41, 53, 52,
  51, 50, 49, 48, 56, 59, 62, 65, 68, 71, 70, 67, 64, 61, 58, 55,
];
var yellowpath = [
  52, 51, 50, 49, 48, 56, 59, 62, 65, 68, 71, 70, 69, 66, 63, 60, 57, 54, 47,
  46, 45, 44, 43, 42, 30, 18, 19, 20, 21, 22, 23, 15, 12, 9, 6, 3, 0, 1, 2, 5,
  8, 11, 14, 17, 24, 25, 26, 27, 28, 29, 41, 40, 39, 38, 37, 36,
];
var rp = [-1, -1, -1, -1];
var gp = [-1, -1, -1, -1];
var bp = [-1, -1, -1, -1];
...
function winner(pl) {
  if (pl === 'r') {
    if (totalpr === 0) {
      ...
      playerroom[0].innerHTML =
        "<img src='crown" + winno + ".png' class='crown'>";
      pmove = 7;
      moves[0] = 0;
      diceRotation(0);
    }
  ...
  if (p === 0) {
    ...
    for (i = 0; i < 4; i++) {
      var blue =
        ...
        i +
        ')" class="rp material-icons b" style="z-index: 0;">stars</span>';
      var green =
        '<span onclick="movegreen(this,' +
        i +
        ')" class="rp material-icons g" style="z-index: 0;">stars</span>';

      var yellow =
        '<span onclick="moveyellow(this,' +
        i +
        ')" class="rp material-icons y" style="z-index: 0;">stars</span>';
    ...
    for (i = 0; i < step.length; i++) {
      if (gp[pno] === i) {
        ...
        step[greenpath[gp[pno]]].innerHTML =
          "<span onclick='movegreen(this," +
          pno +
          ")' class='rp material-icons g'>stars</span>" +
          prevpl;
      } else {
        obj.remove();
      }
    ...
    for (i = 0; i < step.length; i++) {
      if (bp[pno] === i) {
        ...
        step[bluepath[bp[pno]]].innerHTML =
          "<span onclick='moveblue(this," +
          pno +
          ")' class='rp material-icons b'>stars</span>" +
          prevpl;
      } else {
        obj.remove();
      }
    ...
    for (i = 0; i < step.length; i++) {
      if (yp[pno] === i) {
        ...
        step[yellowpath[yp[pno]]].innerHTML =
          "<span onclick='moveyellow(this," +
          pno +
          ")' class='rp material-icons y'>stars</span>" +
          prevpl;
      } else {
        obj.remove();
      }
